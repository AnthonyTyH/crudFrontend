...
document.addEventListener("DOMContentLoaded", () => {
    ...
    form.addEventListener("Submit", async (e) =>{
        ...
        if(file){
            try {
                ...
                alert("Nose pudo subir la imagen. Intenta nuevamnete.");
                alert("Nose pudo subir la imagen. Intenta nuevamente.");
                return; //Si falta la subida, no guardamos producto
            }
        }
  ...
  //14.Rellenar frm para editar producto
